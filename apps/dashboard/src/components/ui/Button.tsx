...
export default function Button({
	...
	const variants = {
		...
		danger:
			"border border-red-500/20 bg-red-500/[0.08] text-red-400 hover:border-red-500/30 hover:bg-red-500/[0.12] hover:text-red-300 disabled:opacity-50",

		ghost:
			"text-zinc-500 hover:bg-white/[0.03] hover:text-zinc-200 disabled:opacity-50",
	};
